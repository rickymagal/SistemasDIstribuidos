...
def start_pubkey_exchange():
    for participant_id in participants:
        if participant_id != client_id:
            # Envia a chave pública para cada participante
            pubkey_data = {
                "ClientID": client_id,
    ...
    # Aguarda a recepção das chaves públicas dos demais participantes
    # Neste ponto, todos os participantes devem ter a chave pública de todos os outros participantes
