...
class apiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.add = channel.unary_unary(
                '/main.api/add',
                request_serializer=grpcMiner__pb2.args.SerializeToString,
                response_deserializer=grpcMiner__pb2.result.FromString,
                )
        self.getTransactionId = channel.unary_unary(
                '/main.api/getTransactionId',
                request_serializer=grpcMiner__pb2.void.SerializeToString,
                response_deserializer=grpcMiner__pb2.intResult.FromString,
                )
        ...
        self.submitChallenge = channel.unary_unary(
                ...
                request_serializer=grpcMiner__pb2.challengeArgs.SerializeToString,
                response_deserializer=grpcMiner__pb2.intResult.FromString,
                )
        ...
        self.getSolution = channel.unary_unary(
                ...
                request_serializer=grpcMiner__pb2.transactionId.SerializeToString,
                response_deserializer=grpcMiner__pb2.structResult.FromString,
                )
...
def add_apiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'add': grpc.unary_unary_rpc_method_handler(
                    servicer.add,
                    request_deserializer=grpcMiner__pb2.args.FromString,
                    response_serializer=grpcMiner__pb2.result.SerializeToString,
            ),
            'getTransactionId': grpc.unary_unary_rpc_method_handler(
                    servicer.getTransactionId,
                    request_deserializer=grpcMiner__pb2.void.FromString,
                    response_serializer=grpcMiner__pb2.intResult.SerializeToString,
            ),
            ...
            'submitChallenge': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=grpcMiner__pb2.challengeArgs.FromString,
                    response_serializer=grpcMiner__pb2.intResult.SerializeToString,
            ),
            ...
            'getSolution': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=grpcMiner__pb2.transactionId.FromString,
                    response_serializer=grpcMiner__pb2.structResult.SerializeToString,
            ),
    }
...
class api(object):
    ...
    def add(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/main.api/add',
            grpcMiner__pb2.args.SerializeToString,
            grpcMiner__pb2.result.FromString,
    ...
    def getTransactionId(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/main.api/getTransactionId',
            grpcMiner__pb2.void.SerializeToString,
            grpcMiner__pb2.intResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def submitChallenge(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/main.api/submitChallenge',
            grpcMiner__pb2.challengeArgs.SerializeToString,
            grpcMiner__pb2.intResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def getSolution(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/main.api/getSolution',
            grpcMiner__pb2.transactionId.SerializeToString,
            grpcMiner__pb2.structResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
